...
package com.pace.httpserver.wupserver;
...
public class WupServerHandler extends com.pace.httpserver.ServerHandler {
    ...
    @Override
    public byte[] reqServerSync(UniPacket uniPacket) {
        return mQRomComponentWupManager.sendSynWupRequest(uniPacket);
    }
